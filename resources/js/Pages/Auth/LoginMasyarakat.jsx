...
export default function LoginMasyarakat() {
    ...
    return (
        <Layout>
            <Head title="Dashboard Masyarakat - P3M Poltekpar Makassar" />
            ...
            <div className="landing-page">
                ...
                <section className="section-padding" id="peta-sebaran" style={{ paddingTop: '60px' }}>
                    <div className="section-header" style={{ marginBottom: '40px' }}>
                        ...
                        <p className="section-description">Eksplorasi interaktif pergerakan dan distribusi kegiatan pengabdian di seluruh wilayah.</p>
                    </div>
                    ...
                    <div className={`map-picking-mode-container ${isPickingLocation ? 'map-picking-mode' : ''}`}>
                        <div className="landing-map-wrapper map-section-boxed">
                            ...
                            {/* Akun Masyarakat Static Desktop Indicator */}
                            <div className="akun-masyarakat-desktop-indicator">
                            ...
                            <div className="map-wrapper-boxed" style={{ borderRadius: '0 0 24px 24px', overflow: 'hidden', position: 'relative' }}>
                                ...
                                >
                                    {/* Mobile Indicator (Only visible < 769px) */}
                                    <div className="akun-masyarakat-mobile-indicator">
                                        <i className="fa-solid fa-users"></i>
                                        <span>Akun Masyarakat</span>
                                    </div>
                                ...
                                {/* FAB "+" Button — Will open Masyarakat PKM form (next prompt) */}
                                <button className="fab" title="Ajukan PKM Masyarakat" onClick={handleFabClick}>
                ...
                {/* General Submission Form Modal */}
                {isFormOpen && <GeneralSubmissionForm onClose={() => setIsFormOpen(false)} />}
            </div>
        </Layout>
    );
}
