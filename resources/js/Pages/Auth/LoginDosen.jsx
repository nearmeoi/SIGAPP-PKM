...
export default function LoginDosen({
    ...
    const [pengajuanData, setPengajuanData] = useState(() => resolveUserSubmissionData(userSubmissionData, { role: 'dosen' }));
    const [submissionHistoryData] = useState(() => resolveUserSubmissionHistory(userSubmissionHistory, 'dosen'));
